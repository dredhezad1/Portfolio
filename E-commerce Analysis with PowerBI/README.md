...
* **Tools:** Power BI, DAX, Power Query (M), SQL.
* **Analytical Frameworks:** P&L Decomposition, ROAS/CPA Optimization, Cohort Analysis, Unit Economics.
* **Data Visualization:** Custom UI/UX design focused on "Storytelling-First" dashboards to answer executive questions in <10 seconds.
* **Data Integrity:** Conducted audits on e-commerce datasets (2021-2024) to resolve marketing spend vs. gross revenue discrepancies.

---

## 💡 How to Use This Repo
1.  **View Dashboards:** Check the `/images` folder for high-resolution screenshots of all 5 pages.
2.  **Logic & Calculations:** See the `/measures` file for the DAX logic used for the CX Score and Churned Revenue.
3.  **Recommendations:** Review the `Final_Strategy_Report.pdf` for the full executive briefing.
